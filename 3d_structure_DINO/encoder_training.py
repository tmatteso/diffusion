...
from diffusion.encoder_losses import DINOv3Loss
...
class ProteinEncoderTrainer:
    ...
    def __init__(
        ...
        Args:
            ...
            criterion: Loss function (e.g., DINOv3Loss)
            optimizer: Optimizer
...
def main():
    ...
    # Configuration (DINOv3 paper defaults)
    config = {
        # Model architecture
        "n_atoms": 37,
        "embed_dim": 768 // 4,
        ...
        "proj_output_dim": 65536 // 16,  # Projection space dimension (DINOv3 default)
        ...
        "lr": 1e-4 / 10000,
        "weight_decay": 0.05,
        # DINOv3 loss parameters (from paper)
    ...
    # Create loss function with DINOv3 paper defaults
    print("Creating loss function...")
    criterion = DINOv3Loss(
