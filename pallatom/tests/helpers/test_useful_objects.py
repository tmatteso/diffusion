"""Tests for LossMetrics, ThroughputStatistics, and ComponentNorms shape contracts."""

import pytest
import torch
from helpers.useful_objects import ComponentNorms, LossMetrics, ThroughputStatistics
...
def test_throughput_statistics_constructs(throughput_statistics: ThroughputStatistics) -> None:
...
def test_component_norms_template_embedder_is_scalar(component_norms: ComponentNorms) -> None:
    """ComponentNorms.template_embedder is a 0-D tensor."""
    assert component_norms.template_embedder.ndim == 0


def test_component_norms_all_fields_finite(component_norms: ComponentNorms) -> None:
